...
function mireya_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'		=> 'mireya-plugin',
			'source'	=> MIREYA_EXTRA_PLUGINS_DIRECTORY . 'normal/mireya-plugin/210123/' . 'mireya-plugin.zip',
			'required'	=> true,
			'version'	=> '1.1.2',
		),
	...
	if ( class_exists( 'MireyaPlugin' ) ) {
		$plugins[] = array(
			...
			'source'				=> MIREYA_EXTRA_PLUGINS_DIRECTORY . 'normal/acf/210123/' . 'advanced-custom-fields-pro.zip',
			'required'			=> true,
			'version'				=> '6.0.7',
		);
	}
